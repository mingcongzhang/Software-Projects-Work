...
//            this.expirySupport.restart(dc);
    ...
    {
        if (this.resizeBehavior.equals(AVKey.RESIZE_SHRINK_ONLY)||this.resizeBehavior.equals(AVKey.RESIZE_SHRINK_ONLY2))
        {
            return Math.min(1d, (this.toViewportScale) * viewport.width / this.size.width);
        }
        else if (this.resizeBehavior.equals(AVKey.RESIZE_STRETCH)||this.resizeBehavior.equals(AVKey.RESIZE_STRETCH2))
        {
            return (this.toViewportScale) * viewport.width / this.size.width;
        }
        else if (this.resizeBehavior.equals(AVKey.RESIZE_KEEP_FIXED_SIZE)||this.resizeBehavior.equals(AVKey.RESIZE_KEEP_FIXED_SIZE2))
        {
            return 1d;
        }
        else

...
unset($error, $user_type, $twilio_conf);
...
<?php if (isset($twilio_conf) && isset($user_type) && $user_type == "admin") : ?>

        <p>Twilio Configured is: <?php echo $twilio_conf ?>. 
        <p>var_dump company_info is: <?php echo var_dump($result); ?>. 

        <p>DONE - Enable Twilio Connect.
